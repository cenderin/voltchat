...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'voltchat.com'
  config.app_name = 'Voltchat'
  config.mailer.from = 'Voltchat <no-reply@voltchat.com>'
  ...
  #
  config.app_secret = 'qRhgebUsCGPl7m6B6ZGIbij-CNzmuhXnRRDcsF-rRi_41a7ZSVUeloLQ4u__lJbGVHk'
